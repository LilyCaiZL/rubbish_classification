...
if __name__ == '__main__':
    root_path = os.getcwd()
    xml_dir = os.path.join(root_path, '/home/linzhexian/dataset/train/image_xml')

    xml_labels = os.listdir(os.path.join(root_path, '/home/linzhexian/dataset/train/image_xml'))
