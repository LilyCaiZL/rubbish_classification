...
#include <vector>
#include <fstream>
//this is some information of picture to be input
int WARMUP_COUNT = 0;
int REPEAT_COUNT = 1;
...
//this is the classify result such as the id of name,class ,confidence score
struct RESULT {
...
//the preprocess of picture,let picture become matrix,resize,BGRA2RGB,be in 0 and 1
...
// matrix to picture ,get class,score,index of top 3 .there is a unknown class
